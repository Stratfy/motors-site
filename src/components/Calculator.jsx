  ...
  return (
    <div className="calculator">
      ...
      <div className="calculator-buttons">
        ...
        <button className="btn-operation" onClick={() => performOperation('÷')}>
          ÷
        </button>
        <button className="btn-operation" onClick={() => performOperation('×')}>
          ×
        ...
        <button className="btn-operation btn-plus" onClick={() => performOperation('+')}>
          +
        </button>
        ...
        <button className="btn-number btn-zero" onClick={() => inputNumber(0)}>
          0
        </button>
